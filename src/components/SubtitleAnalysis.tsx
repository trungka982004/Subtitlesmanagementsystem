    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-blue-900">Total Characters</span>
          </div>
          <p className="text-blue-900">{stats.totalChars.toLocaleString()}</p>
        ...
        <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-purple-900">Reading Speed</span>
          </div>
        ...
        <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-orange-900">Issues</span>
          </div>
      ...
      {stats.translationProgress > 0 && (
        <div className="p-4 bg-white rounded-lg border border-gray-200">
          <h3 className="text-gray-900 mb-3">Translation Progress</h3>
      ...
      <div className="bg-white p-4 rounded-lg border border-gray-200">
        <h3 className="text-gray-900 mb-4">Reading Speed Analysis</h3>
      ...
      {files.length > 1 && (
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <h3 className="text-gray-900 mb-4">File Comparison</h3>
          <ResponsiveContainer width="100%" height={300}>
